...
/**
 * Usage:
 *  echo Mage::getModel('mktr_tracker/Array2XML')->createXML('root_node_name', $array)->saveXML();
 */

class Mktr_Tracker_Model_Array2XML
{
    ...
    public static function init($version = null, $encoding = null, $standalone = null, $format_output = null,
        $labelAttributes = null, $labelCData = null, $labelDocType = null, $labelValue = null) {
    ...
    /** @noinspection PhpUnused */
    public function createXML($node_name, $arr = array(), $docType = array())
    {
        return self::cXML($node_name, $arr, $docType);
    }

    public static function cXML($node_name, $arr = array(), $docType = array())
    {
    ...
    /** @noinspection PhpUnused */
    public function getConvert($node_name, $arr = array())
    {
        /** @noinspection PhpUnhandledExceptionInspection */
